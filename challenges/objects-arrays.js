...
console.log(velociraptor.diet);//Done!

// How long was a stegosaurus?
console.log(stegosaurus.length);//Done!

// What time period did tyrannosaurus live in?
console.log(tyrannosaurus.period);//Done!

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
tyrannosaurus.roar = function() {
    console.log('RAWERSRARARWERSARARARRRR!');
}
console.log(tyrannosaurus.roar());//Done!
...
const contactInfo = graduates.map((std) => {
  return `${std.first_name} ${std.email}`;
});
...
*/
const lowCaseAnimalNames = zooAnimals.map(list => {
  return list.animal_name.toLowerCase();
});
console.log(lowCaseAnimalNames); //Done!
